...
- **Platt 2-bin disclosure:** n_val=12 -> ece_bins = max(2, n_val//5)=2 counts [6,6] per eval/calibration_curve.png 750x600 2-bin with counts, ECE 2-bin 0.21 kernel 0.21 CI [0.18,0.24] 2000-boot, Brier 0.117 < base-rate 0.243 CI [0.088,0.146] non-overlap vs base, Platt only (! grep iso-tonic), never isotonic at n<1000 per sklearn, disclosed Platt unpowered at n_cal<20 2 bins caveat in LEAKAGE_REPORT and risk_model header, n_risk45 n_prior20 n_eff10 n_families10.
