    ...
    <div style={{ background: TOK.card, border: `1px solid ${TOK.border}`, borderRadius: 12, padding: 12 }}>
      ...
      {tab === 'AI' && (
        <div style={{ fontSize: 13, color: TOK.text }}>
          ...
          <div style={{ marginTop: 6, color: TOK.muted, fontSize: 10, fontStyle: 'italic' }}>WEAK SUPERVISION: Labels are rule-derived weak supervision (score.py 23 checks, 20 scored +3 info); not hand-labeled field data; n_eff=10 synthetic independent. See Dataset Charter §1/§4a.</div>
        </div>
      )}
      {tab === 'Coverage' && (
