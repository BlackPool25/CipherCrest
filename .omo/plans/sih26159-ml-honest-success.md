...
- [x] 5. De-duplicate manifest to 500 proper distinct coherent families (families theater #3)
...
- [x] 9. Implement FlyingSquid m=6 triplet for critical metrics (your pick) — fix MajorityVoter theater
...
- [x] 10. Fix feature circularity with honest importance inside outer fold
...
- [x] 11. Scale anomaly ensemble honest 200x5 with soft-vote and ja4 ablation — fix clamp + TOP5 sparsity + gate
...
- [x] 12. Implement unseen-packet generalization protocol (your #1 requirement) — fix holdout 1.0 vs nested 0.714 gap theater
...
- [x] 13. Active learning 15 human via KMeans+entropy LOO Platt B=2 disjoint — fix simulated +0.06 and 15 positives theater
...
- [x] 16. Metrics headline AP+Brier joint and EVIDENCE honest success — fix lax gates pooled<0.40 theater
